...
struct set_reverse_iterator {
    ...
    set_reverse_iterator(tree_type* tree_, link_type* link_): tree(tree_), link(link_) {}
...
struct set_const_reverse_iterator {
    ...
    set_const_reverse_iterator(tree_type* tree_, link_type* link_): tree(tree_), link(link_) {}
