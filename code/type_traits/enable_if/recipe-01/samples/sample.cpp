...
template<class T>
typename Hx::enable_if<std::is_trivially_default_constructible<T>::value>::type 
    construct(T*) 
{
...
Hx::enable_if_t<std::is_constructible<T, Args&&...>::value> // Using helper type
...
template<class T,
	typename = Hx::enable_if_t<std::is_array<T>::value> >
...
/*
template<class T,
	typename = Hx::enable_if_t<std::is_void<T>::value> >
...
template<class T>
class A<T, typename Hx::enable_if<std::is_floating_point<T>::value>::type> {
